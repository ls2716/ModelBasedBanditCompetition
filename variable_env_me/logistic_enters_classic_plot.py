...
This file corresponds to games where the logistic agent enters the game
...
images_folder = f'images/variable_env_me/logistic_enters_classic_no_actions_{no_actions}_T_{T}_{env_name}'
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    results_folder, 'first_1000.txt'), 'Classic Eps-Greedy', 'Logistic Eps-Greedy entering')
...
ut.plot_smooth_reward_history(
    ...
    bandit2_name='Logistic Eps-Greedy entering', foldername=images_folder, filename='', title=None, show_plot=False)
...
logger.info(f'Mean action of the bandit 1 (classic): {bandit_1_mean_action}')
logger.info(f'Mean action of the bandit 2 (logistic): {bandit_2_mean_action}')
logger.info(f'Mean reward of the bandit 1 (classic): {reward_1_mean_500}')
logger.info(f'Mean reward of the bandit 2 (logistic): {reward_2_mean_500}')
