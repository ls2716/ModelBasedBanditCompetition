...
In this script, the classic agent enters the game with the logistic agent.
The agents are non-stationary and the logistic agent is fully converged.
...
# Plotting parameters
results_folder = f'results/prior_me/classic_enters_logistic_no_actions_{no_actions}_T_{T}_{suffix}'
...
# Feed fake observations
model_1.set_prior_observations(fake_margins, fake_observations)
