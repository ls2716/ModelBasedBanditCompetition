...
# Folder parameters
result_folder = f'results/prior_me/fluc_epsgreedy_logistic_{no_actions}_obs'
...
no_obs = 4
action_indices = np.array([0, 0, 0,   5, 6, 7, 8]*no_obs)
margin_map = {0: -1, 1: 0, 2: 0.1, 3: 0.3, 5: 0.5, 6: 0.7, 7: 0.9, 8: 1.}
observation_map = {0: 1., 1: 0., 2: 0., 3: 0., 5: 0., 6: 0., 7: 0., 8: 0.}
