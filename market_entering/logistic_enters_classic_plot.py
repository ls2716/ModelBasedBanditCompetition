...
ut.plot_smooth_reward_history(
    reward_history, bandit1_name='Classic $\\varepsilon$-greedy',
    bandit2_name='Logistic $\\varepsilon$-greedy entering', foldername=images_folder, filename='lvsc', title=None, show_plot=False)
