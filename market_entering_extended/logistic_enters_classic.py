...
In this file, the script runs pricing competitions where the logistic agent enters
 the game with the classic agent already present and fully converged.
...
# Plotting parameters
results_folder = f'results/market_entering/logistic_enters_classic_no_actions_{no_actions}_T_{T}_tau_{tau_logistic}'
