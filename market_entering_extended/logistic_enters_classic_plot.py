...
the simulations where the logistic agent enters the environment in which 
the classic agent is already present and fully converged.

The plotting is based on the simulations run
in market_entering_extended/logistic_enters_classic.py
"""
...
# Plotting parameters
results_folder = f'results/market_entering_extended/logistic_enters_classic_no_actions_{no_actions}_T_{T}_tau_{tau}'
images_folder = f'images/market_entering_extended/logistic_enters_classic_no_actions_{no_actions}_T_{T}_tau_{tau}'
